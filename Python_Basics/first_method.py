...
# print('Hello, World! 3')  # Not part of the function due to lack of indentation
...
''' In Python, adding two blank lines before a top-level function or class definition is part of the 
    official PEP 8 style guide. '''
''' ✅ Rule: Top-level functions (functions not inside a class or another function) should be surrounded by 
    two blank lines above and below (though one after is often sufficient unless followed by another top-level 
    definition).    '''
