...
# --- Difference b/w the return and print keyword

"""
return is a keyword that exits a function and sends a value back to the caller for further processing, 
while print() is a function that displays output to the console for human viewing.
"""

# Example: Return allows reuse
def add_one(n):
    return n + 1

result = add_one(5)  # result is 6
print(result)        # Prints 6

# Example: Print does not allow reuse
def show_one(n):
    print(n + 1)
