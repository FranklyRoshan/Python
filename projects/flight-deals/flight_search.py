...
class FlightSearch:
    ...
    def check_flight(self, origin_city_code, destination_city_code, from_time: datetime, to_time: datetime, is_direct=True):
        """
        ...
        # Only include stops parameters if is_direct is True
        if is_direct:
            query["stop"] = "1"
